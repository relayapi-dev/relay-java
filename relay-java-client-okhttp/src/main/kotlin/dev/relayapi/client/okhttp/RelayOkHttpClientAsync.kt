...
package dev.relayapi.client.okhttp

import com.fasterxml.jackson.databind.json.JsonMapper
import dev.relayapi.client.RelayClientAsync
import dev.relayapi.client.RelayClientAsyncImpl
...
/**
 * A class that allows building an instance of [RelayClientAsync] with [OkHttpClient] as the
 * underlying [HttpClient].
 */
class RelayOkHttpClientAsync private constructor() {

    companion object {

        /** Returns a mutable builder for constructing an instance of [RelayClientAsync]. */
         ...
         */
        @JvmStatic fun fromEnv(): RelayClientAsync = builder().fromEnv().build()
    }

    /** A builder for [RelayOkHttpClientAsync]. */
    class Builder internal constructor() {
         ...
         *
         * Defaults to [dev.relayapi.core.jsonMapper]. The default is usually sufficient and rarely
         ...
         *
         * Defaults to the production environment: `https://api.relayapi.dev`.
         */
        ...
        /**
         * Returns an immutable instance of [RelayClientAsync].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): RelayClientAsync =
            RelayClientAsyncImpl(
                clientOptions
                    .httpClient(
