...
/**
 * A class that allows building an instance of [RelayClient] with [OkHttpClient] as the underlying
 * [HttpClient].
 */
class RelayOkHttpClient private constructor() {

    companion object {

        /** Returns a mutable builder for constructing an instance of [RelayClient]. */
         ...
         */
        @JvmStatic fun fromEnv(): RelayClient = builder().fromEnv().build()
    }

    /** A builder for [RelayOkHttpClient]. */
    class Builder internal constructor() {
        ...
        /**
         * Returns an immutable instance of [RelayClient].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): RelayClient =
            RelayClientImpl(
                clientOptions
                    .httpClient(
