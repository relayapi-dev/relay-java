...
dependencies {
    testImplementation(project(":relay-java"))
...
val proguardJar by tasks.registering(proguard.gradle.ProGuardTask::class) {
    ...
    configuration("../relay-java-core/src/main/resources/META-INF/proguard/relay-java-core.pro")
}
...
val testProGuard by tasks.registering(JavaExec::class) {
    ...
    mainClass.set("dev.relayapi.proguard.ProGuardCompatibilityTest")
...
val r8Jar by tasks.registering(JavaExec::class) {
    ...
    args = listOf(
        ...
        "--pg-conf", "./test.pro",
        "--pg-conf", "../relay-java-core/src/main/resources/META-INF/proguard/relay-java-core.pro",
