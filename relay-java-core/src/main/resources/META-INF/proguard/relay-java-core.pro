...
-keep @com.fasterxml.jackson.databind.annotation.JsonSerialize class dev.relayapi.** { *; }
-keep @com.fasterxml.jackson.databind.annotation.JsonDeserialize class dev.relayapi.** { *; }

# Jackson uses reflection to serialize and deserialize our classes based on their constructors and annotated members.
-keepclassmembers class dev.relayapi.** {
    <init>(...);
