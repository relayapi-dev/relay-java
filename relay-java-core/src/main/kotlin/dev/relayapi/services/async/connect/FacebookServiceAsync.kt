...
interface FacebookServiceAsync {
     ...
     */
    fun withOptions(modifier: Consumer<ClientOptions.Builder>): FacebookServiceAsync

    fun pages(): PageServiceAsync

    /**
     * A view of [FacebookServiceAsync] that provides access to raw HTTP responses for each method.
     */
