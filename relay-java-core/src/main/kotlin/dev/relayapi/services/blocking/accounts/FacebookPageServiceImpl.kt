...
class FacebookPageServiceImpl internal constructor(private val clientOptions: ClientOptions) :
    FacebookPageService {

    private val withRawResponse: FacebookPageService.WithRawResponse by lazy {
        WithRawResponseImpl(clientOptions)
    }

    override fun withRawResponse(): FacebookPageService.WithRawResponse = withRawResponse

    override fun withOptions(modifier: Consumer<ClientOptions.Builder>): FacebookPageService =
        FacebookPageServiceImpl(clientOptions.toBuilder().apply(modifier::accept).build())
    ...
    class WithRawResponseImpl internal constructor(private val clientOptions: ClientOptions) :
        ...
        override fun withOptions(
            ...
            FacebookPageServiceImpl.WithRawResponseImpl(
