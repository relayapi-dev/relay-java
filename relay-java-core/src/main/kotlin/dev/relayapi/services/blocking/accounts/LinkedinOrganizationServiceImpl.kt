...
class LinkedinOrganizationServiceImpl
internal constructor(private val clientOptions: ClientOptions) : LinkedinOrganizationService {

    private val withRawResponse: LinkedinOrganizationService.WithRawResponse by lazy {
        WithRawResponseImpl(clientOptions)
    }

    override fun withRawResponse(): LinkedinOrganizationService.WithRawResponse = withRawResponse

    override fun withOptions(
        modifier: Consumer<ClientOptions.Builder>
    ): LinkedinOrganizationService =
        LinkedinOrganizationServiceImpl(clientOptions.toBuilder().apply(modifier::accept).build())
    ...
    override fun switchType(
        ...
        withRawResponse().switchType(params, requestOptions).parse()
    ...
    class WithRawResponseImpl internal constructor(private val clientOptions: ClientOptions) :
        ...
        override fun withOptions(
            ...
            LinkedinOrganizationServiceImpl.WithRawResponseImpl(
