...
private constructor(
     ...
     *
     * Use the one published in `relay-java-client-okhttp` or implement your own.
     *
    ...
    companion object {
        ...
        const val PRODUCTION_URL = "https://api.relayapi.dev"
    ...
    class Builder internal constructor() {
        ...
        fun fromEnv() = apply {
            ...
            (System.getProperty("relay.apiKey") ?: System.getenv("RELAY_API_KEY"))?.let {
                apiKey(it)
            }
            System.getenv("RELAY_CUSTOM_HEADERS")?.let { customHeadersEnv ->
