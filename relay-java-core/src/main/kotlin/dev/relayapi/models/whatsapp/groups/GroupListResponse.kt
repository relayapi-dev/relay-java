...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(groupListResponse: GroupListResponse) = apply {
            data = groupListResponse.data.map { it.toMutableList() }
    ...
    private constructor(
         ...
         *
         * Unlike [contactCount], this method doesn't throw if the JSON field has an unexpected
         * type.
         */
        @JsonProperty("contact_count")
        @ExcludeMissing
        ...
        class Builder internal constructor() {
             ...
             *
             * You should usually call [Builder.contactCount] with a well-typed [Double] value
        ...
        override fun toString() =
            "Data{id=$id, contactCount=$contactCount, createdAt=$createdAt, name=$name, description=$description, additionalProperties=$additionalProperties}"
    }
    ...
    override fun toString() =
        "GroupListResponse{data=$data, additionalProperties=$additionalProperties}"
}
