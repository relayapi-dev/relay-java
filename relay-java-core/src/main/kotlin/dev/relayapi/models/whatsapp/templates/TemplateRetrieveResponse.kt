...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(templateRetrieveResponse: TemplateRetrieveResponse) = apply {
            category = templateRetrieveResponse.category
            components = templateRetrieveResponse.components.map { it.toMutableList() }
            language = templateRetrieveResponse.language
            name = templateRetrieveResponse.name
            status = templateRetrieveResponse.status
    ...
    override fun toString() =
        "TemplateRetrieveResponse{category=$category, components=$components, language=$language, name=$name, status=$status, additionalProperties=$additionalProperties}"
}
