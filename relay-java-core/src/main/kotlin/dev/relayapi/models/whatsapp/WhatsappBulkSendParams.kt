...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [WhatsappBulkSendParams].
         *
    ...
    /** A builder for [WhatsappBulkSendParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(whatsappBulkSendParams: WhatsappBulkSendParams) = apply {
            body = whatsappBulkSendParams.body.toBuilder()
            additionalHeaders = whatsappBulkSendParams.additionalHeaders.toBuilder()
            additionalQueryParams = whatsappBulkSendParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [WhatsappBulkSendParams].
         *
         ...
         */
        fun build(): WhatsappBulkSendParams =
    ...
    private constructor(
        ...
        ) : this(accountId, recipients, template, mutableMapOf())
        ...
        private val hashCode: Int by lazy {
            Objects.hash(accountId, recipients, template, additionalProperties)
        }

        override fun hashCode(): Int = hashCode

        override fun toString() =
            "Body{accountId=$accountId, recipients=$recipients, template=$template, additionalProperties=$additionalProperties}"
    }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is WhatsappBulkSendParams &&
            body == other.body &&
    ...
    override fun toString() =
        "WhatsappBulkSendParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
