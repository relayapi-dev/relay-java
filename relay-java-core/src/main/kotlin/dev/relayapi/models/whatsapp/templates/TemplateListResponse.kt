...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(templateListResponse: TemplateListResponse) = apply {
            data = templateListResponse.data.map { it.toMutableList() }
    ...
    private constructor(
        ...
        class Builder internal constructor() {
            ...
            internal fun from(data: Data) = apply {
                ...
                components = data.components.map { it.toMutableList() }
        ...
        override fun toString() =
            "Data{category=$category, components=$components, language=$language, name=$name, status=$status, additionalProperties=$additionalProperties}"
    }
    ...
    override fun toString() =
        "TemplateListResponse{data=$data, additionalProperties=$additionalProperties}"
}
