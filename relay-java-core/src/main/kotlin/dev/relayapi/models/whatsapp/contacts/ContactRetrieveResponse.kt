...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(contactRetrieveResponse: ContactRetrieveResponse) = apply {
            id = contactRetrieveResponse.id
            createdAt = contactRetrieveResponse.createdAt
            optedIn = contactRetrieveResponse.optedIn
            phone = contactRetrieveResponse.phone
            email = contactRetrieveResponse.email
            groups = contactRetrieveResponse.groups.map { it.toMutableList() }
            name = contactRetrieveResponse.name
            tags = contactRetrieveResponse.tags.map { it.toMutableList() }
    ...
    override fun toString() =
        "ContactRetrieveResponse{id=$id, createdAt=$createdAt, optedIn=$optedIn, phone=$phone, email=$email, groups=$groups, name=$name, tags=$tags, additionalProperties=$additionalProperties}"
}
