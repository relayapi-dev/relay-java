...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(broadcastSendResponse: BroadcastSendResponse) = apply {
            id = broadcastSendResponse.id
            createdAt = broadcastSendResponse.createdAt
            name = broadcastSendResponse.name
            recipientCount = broadcastSendResponse.recipientCount
            status = broadcastSendResponse.status
            template = broadcastSendResponse.template
            failed = broadcastSendResponse.failed
            scheduledAt = broadcastSendResponse.scheduledAt
            sent = broadcastSendResponse.sent
    ...
    override fun toString() =
        "BroadcastSendResponse{id=$id, createdAt=$createdAt, name=$name, recipientCount=$recipientCount, status=$status, template=$template, failed=$failed, scheduledAt=$scheduledAt, sent=$sent, additionalProperties=$additionalProperties}"
}
