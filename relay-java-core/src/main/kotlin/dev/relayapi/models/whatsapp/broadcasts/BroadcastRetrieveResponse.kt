...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(broadcastRetrieveResponse: BroadcastRetrieveResponse) = apply {
            id = broadcastRetrieveResponse.id
            createdAt = broadcastRetrieveResponse.createdAt
            name = broadcastRetrieveResponse.name
            recipientCount = broadcastRetrieveResponse.recipientCount
            status = broadcastRetrieveResponse.status
            template = broadcastRetrieveResponse.template
            failed = broadcastRetrieveResponse.failed
            scheduledAt = broadcastRetrieveResponse.scheduledAt
            sent = broadcastRetrieveResponse.sent
    ...
    override fun toString() =
        "BroadcastRetrieveResponse{id=$id, createdAt=$createdAt, name=$name, recipientCount=$recipientCount, status=$status, template=$template, failed=$failed, scheduledAt=$scheduledAt, sent=$sent, additionalProperties=$additionalProperties}"
}
