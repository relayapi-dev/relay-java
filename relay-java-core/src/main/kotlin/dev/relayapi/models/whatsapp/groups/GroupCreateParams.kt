...
private constructor(
     ...
     */
    fun contactIds(): Optional<List<String>> = body.contactIds()
    ...
    private constructor(
        ...
        ) : this(accountId, name, contactIds, description, mutableMapOf())
         ...
         *   server responded with an unexpected value).
         */
        fun contactIds(): Optional<List<String>> = contactIds.getOptional("contact_ids")
        ...
        class Builder internal constructor() {
            ...
            fun build(): Body =
                Body(
                    ...
                    (contactIds ?: JsonMissing.of()).map { it.toImmutable() },
                    description,
        ...
        private val hashCode: Int by lazy {
            Objects.hash(accountId, name, contactIds, description, additionalProperties)
        }

        override fun hashCode(): Int = hashCode

        override fun toString() =
            "Body{accountId=$accountId, name=$name, contactIds=$contactIds, description=$description, additionalProperties=$additionalProperties}"
    }
