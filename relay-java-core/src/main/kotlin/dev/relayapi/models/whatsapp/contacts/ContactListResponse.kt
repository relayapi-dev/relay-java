...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(contactListResponse: ContactListResponse) = apply {
            data = contactListResponse.data.map { it.toMutableList() }
            hasMore = contactListResponse.hasMore
            nextCursor = contactListResponse.nextCursor
    ...
    private constructor(
        ...
        private constructor(
            ...
            @ExcludeMissing
            optedIn: JsonField<Boolean> = JsonMissing.of(),
        ...
        class Builder internal constructor() {
             ...
             *
             * You should usually call [Builder.optedIn] with a well-typed [Boolean] value instead.
        ...
        override fun toString() =
            "Data{id=$id, createdAt=$createdAt, optedIn=$optedIn, phone=$phone, email=$email, groups=$groups, name=$name, tags=$tags, additionalProperties=$additionalProperties}"
    }
    ...
    override fun toString() =
        "ContactListResponse{data=$data, hasMore=$hasMore, nextCursor=$nextCursor, additionalProperties=$additionalProperties}"
}
