...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(broadcastListResponse: BroadcastListResponse) = apply {
            data = broadcastListResponse.data.map { it.toMutableList() }
            hasMore = broadcastListResponse.hasMore
            nextCursor = broadcastListResponse.nextCursor
    ...
    private constructor(
         ...
         *
         * Unlike [recipientCount], this method doesn't throw if the JSON field has an unexpected
         * type.
         */
        @JsonProperty("recipient_count")
        @ExcludeMissing
        ...
        class Builder internal constructor() {
            ...
            /** Total recipients */
            fun recipientCount(recipientCount: Double) =
                recipientCount(JsonField.of(recipientCount))
        ...
        override fun toString() =
            "Data{id=$id, createdAt=$createdAt, name=$name, recipientCount=$recipientCount, status=$status, template=$template, failed=$failed, scheduledAt=$scheduledAt, sent=$sent, additionalProperties=$additionalProperties}"
    }
    ...
    override fun toString() =
        "BroadcastListResponse{data=$data, hasMore=$hasMore, nextCursor=$nextCursor, additionalProperties=$additionalProperties}"
}
