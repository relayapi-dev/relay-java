...
private constructor(
    ...
    private constructor(
        ...
        ) : this(accountId, category, components, language, name, mutableMapOf())
        ...
        private val hashCode: Int by lazy {
            Objects.hash(accountId, category, components, language, name, additionalProperties)
        }

        override fun hashCode(): Int = hashCode

        override fun toString() =
            "Body{accountId=$accountId, category=$category, components=$components, language=$language, name=$name, additionalProperties=$additionalProperties}"
    }
