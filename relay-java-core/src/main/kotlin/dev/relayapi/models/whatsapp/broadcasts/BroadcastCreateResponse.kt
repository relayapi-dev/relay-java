...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(broadcastCreateResponse: BroadcastCreateResponse) = apply {
            id = broadcastCreateResponse.id
            createdAt = broadcastCreateResponse.createdAt
            name = broadcastCreateResponse.name
            recipientCount = broadcastCreateResponse.recipientCount
            status = broadcastCreateResponse.status
            template = broadcastCreateResponse.template
            failed = broadcastCreateResponse.failed
            scheduledAt = broadcastCreateResponse.scheduledAt
            sent = broadcastCreateResponse.sent
    ...
    override fun toString() =
        "BroadcastCreateResponse{id=$id, createdAt=$createdAt, name=$name, recipientCount=$recipientCount, status=$status, template=$template, failed=$failed, scheduledAt=$scheduledAt, sent=$sent, additionalProperties=$additionalProperties}"
}
