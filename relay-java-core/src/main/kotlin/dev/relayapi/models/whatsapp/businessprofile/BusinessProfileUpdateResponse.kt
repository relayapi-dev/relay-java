...
class BusinessProfileUpdateResponse
...
private constructor(
    ...
    /** A builder for [BusinessProfileUpdateResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(businessProfileUpdateResponse: BusinessProfileUpdateResponse) = apply {
            about = businessProfileUpdateResponse.about
            address = businessProfileUpdateResponse.address
            description = businessProfileUpdateResponse.description
            email = businessProfileUpdateResponse.email
            profilePictureUrl = businessProfileUpdateResponse.profilePictureUrl
            websites = businessProfileUpdateResponse.websites.map { it.toMutableList() }
            additionalProperties = businessProfileUpdateResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [BusinessProfileUpdateResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): BusinessProfileUpdateResponse =
            BusinessProfileUpdateResponse(
                about,
                address,
                description,
    ...
    fun validate(): BusinessProfileUpdateResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BusinessProfileUpdateResponse &&
            about == other.about &&
    ...
    override fun toString() =
        "BusinessProfileUpdateResponse{about=$about, address=$address, description=$description, email=$email, profilePictureUrl=$profilePictureUrl, websites=$websites, additionalProperties=$additionalProperties}"
}
