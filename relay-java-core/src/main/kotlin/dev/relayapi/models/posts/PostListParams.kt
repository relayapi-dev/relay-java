...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        fun build(): PostListParams =
            PostListParams(cursor, limit, additionalHeaders.build(), additionalQueryParams.build())
    }
    ...
    override fun toString() =
        "PostListParams{cursor=$cursor, limit=$limit, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
