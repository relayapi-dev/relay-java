...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): LogRetrieveParams = builder().build()
    ...
    class Builder internal constructor() {
        ...
        fun build(): LogRetrieveParams =
            LogRetrieveParams(id, additionalHeaders.build(), additionalQueryParams.build())
    }
    ...
    override fun toString() =
        "LogRetrieveParams{id=$id, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
