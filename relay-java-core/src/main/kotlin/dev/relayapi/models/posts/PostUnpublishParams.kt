...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): PostUnpublishParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [PostUnpublishParams]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [PostUnpublishParams]. */
