...
private constructor(
    ...
    override fun toString() =
        "PostRetryResponse{id=$id, content=$content, createdAt=$createdAt, media=$media, recycledFromId=$recycledFromId, recycling=$recycling, scheduledAt=$scheduledAt, status=$status, targets=$targets, updatedAt=$updatedAt, additionalProperties=$additionalProperties}"
}
