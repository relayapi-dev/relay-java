...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [PostRetryResponse].
         *
    ...
    /** A builder for [PostRetryResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(postRetryResponse: PostRetryResponse) = apply {
            id = postRetryResponse.id
            content = postRetryResponse.content
            createdAt = postRetryResponse.createdAt
            media = postRetryResponse.media.map { it.toMutableList() }
            publishedAt = postRetryResponse.publishedAt
            recycledFromId = postRetryResponse.recycledFromId
            recycling = postRetryResponse.recycling
            scheduledAt = postRetryResponse.scheduledAt
            status = postRetryResponse.status
            targets = postRetryResponse.targets
            updatedAt = postRetryResponse.updatedAt
            metrics = postRetryResponse.metrics
            targetOptions = postRetryResponse.targetOptions
            threadGroupId = postRetryResponse.threadGroupId
            threadPosition = postRetryResponse.threadPosition
            timezone = postRetryResponse.timezone
            additionalProperties = postRetryResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [PostRetryResponse].
         *
    ...
    fun validate(): PostRetryResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is PostRetryResponse &&
            id == other.id &&
