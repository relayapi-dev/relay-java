...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(logListResponse: LogListResponse) = apply {
            data = logListResponse.data.map { it.toMutableList() }
            hasMore = logListResponse.hasMore
            nextCursor = logListResponse.nextCursor
    ...
    override fun toString() =
        "LogListResponse{data=$data, hasMore=$hasMore, nextCursor=$nextCursor, additionalProperties=$additionalProperties}"
}
