...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [PostUpdateResponse].
         *
    ...
    /** A builder for [PostUpdateResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(postUpdateResponse: PostUpdateResponse) = apply {
            id = postUpdateResponse.id
            content = postUpdateResponse.content
            createdAt = postUpdateResponse.createdAt
            media = postUpdateResponse.media.map { it.toMutableList() }
            publishedAt = postUpdateResponse.publishedAt
            recycledFromId = postUpdateResponse.recycledFromId
            recycling = postUpdateResponse.recycling
            scheduledAt = postUpdateResponse.scheduledAt
            status = postUpdateResponse.status
            targets = postUpdateResponse.targets
            updatedAt = postUpdateResponse.updatedAt
            metrics = postUpdateResponse.metrics
            targetOptions = postUpdateResponse.targetOptions
            threadGroupId = postUpdateResponse.threadGroupId
            threadPosition = postUpdateResponse.threadPosition
            timezone = postUpdateResponse.timezone
            additionalProperties = postUpdateResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [PostUpdateResponse].
         *
    ...
    fun validate(): PostUpdateResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is PostUpdateResponse &&
            id == other.id &&
