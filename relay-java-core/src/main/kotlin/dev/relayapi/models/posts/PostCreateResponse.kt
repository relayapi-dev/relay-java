...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [PostCreateResponse].
         *
    ...
    /** A builder for [PostCreateResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(postCreateResponse: PostCreateResponse) = apply {
            id = postCreateResponse.id
            content = postCreateResponse.content
            createdAt = postCreateResponse.createdAt
            media = postCreateResponse.media.map { it.toMutableList() }
            publishedAt = postCreateResponse.publishedAt
            recycledFromId = postCreateResponse.recycledFromId
            recycling = postCreateResponse.recycling
            scheduledAt = postCreateResponse.scheduledAt
            ...
            targetOptions = postCreateResponse.targetOptions
            threadGroupId = postCreateResponse.threadGroupId
            threadPosition = postCreateResponse.threadPosition
            timezone = postCreateResponse.timezone
        ...
        /**
         * Returns an immutable instance of [PostCreateResponse].
         *
    ...
    fun validate(): PostCreateResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is PostCreateResponse &&
            id == other.id &&
