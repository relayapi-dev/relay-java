...
private constructor(
    ...
    private constructor(
        ...
        override fun toString() =
            "Post{scheduledAt=$scheduledAt, targets=$targets, content=$content, media=$media, targetOptions=$targetOptions, timezone=$timezone, additionalProperties=$additionalProperties}"
    }
