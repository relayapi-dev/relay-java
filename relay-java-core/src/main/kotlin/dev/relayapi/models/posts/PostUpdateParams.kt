...
private constructor(
     ...
     *   server responded with an unexpected value).
     */
    fun targets(): Optional<List<String>> = body.targets()
    ...
    companion object {
        ...
        @JvmStatic fun none(): PostUpdateParams = builder().build()
    ...
    class Builder internal constructor() {
        ...
        internal fun from(postUpdateParams: PostUpdateParams) = apply {
            ...
            body = postUpdateParams.body.toBuilder()
    ...
    private constructor(
         ...
         *   server responded with an unexpected value).
         */
        fun targets(): Optional<List<String>> = targets.getOptional("targets")
    ...
    override fun toString() =
        "PostUpdateParams{id=$id, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
