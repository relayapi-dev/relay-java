...
private constructor(
    ...
    private constructor(
        ...
        override fun toString() =
            "Body{scheduledAt=$scheduledAt, targets=$targets, content=$content, media=$media, recycling=$recycling, targetOptions=$targetOptions, timezone=$timezone, workspaceId=$workspaceId, additionalProperties=$additionalProperties}"
    }
