...
/**
 * Create a post. Use scheduled_at: "now" to publish immediately, "draft" to save as draft, or an
 * ISO timestamp to schedule.
 */
...
private constructor(
    ...
    /**
     * Cross-post actions to execute after publishing (e.g., repost from another account, comment
    ...
    /**
     * Shorten URLs in post content. Only relevant when short link mode is 'ask'. Ignored when mode
     * is 'always' or 'never'. (Pro plan only)
     *
     * @throws RelayInvalidDataException if the JSON field has an unexpected type (e.g. if the
     *   server responded with an unexpected value).
     */
    fun shortenUrls(): Optional<Boolean> = body.shortenUrls()
     ...
     *   server responded with an unexpected value).
     */
    fun skipSignature(): Optional<Boolean> = body.skipSignature()
    ...
    /**
     * Content template ID. When provided, the template content is used as the base for the post.
     * Explicit 'content' field takes precedence.
     *
     * @throws RelayInvalidDataException if the JSON field has an unexpected type (e.g. if the
     *   server responded with an unexpected value).
     */
     ...
     */
    fun _shortenUrls(): JsonField<Boolean> = body._shortenUrls()

    /**
     * Returns the raw JSON value of [skipSignature].
     *
     * Unlike [skipSignature], this method doesn't throw if the JSON field has an unexpected type.
     */
    fun _skipSignature(): JsonField<Boolean> = body._skipSignature()
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [PostCreateParams].
         *
    ...
    /** A builder for [PostCreateParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(postCreateParams: PostCreateParams) = apply {
            body = postCreateParams.body.toBuilder()
            additionalHeaders = postCreateParams.additionalHeaders.toBuilder()
            additionalQueryParams = postCreateParams.additionalQueryParams.toBuilder()
        }
         ...
         */
        fun crossPostActions(crossPostActions: List<CrossPostAction>) = apply {
            body.crossPostActions(crossPostActions)
        }
         ...
         * `List<CrossPostAction>` value instead. This method is primarily for setting the field to
         ...
         */
        fun shortenUrls(shortenUrls: Boolean) = apply { body.shortenUrls(shortenUrls) }

        /**
         * Sets [Builder.shortenUrls] to an arbitrary JSON value.
         *
         * You should usually call [Builder.shortenUrls] with a well-typed [Boolean] value instead.
         * This method is primarily for setting the field to an undocumented or not yet supported
         * value.
         */
        fun shortenUrls(shortenUrls: JsonField<Boolean>) = apply { body.shortenUrls(shortenUrls) }

        /** When true, the default signature is not auto-appended even if one is configured. */
        fun skipSignature(skipSignature: Boolean) = apply { body.skipSignature(skipSignature) }
        ...
        fun skipSignature(skipSignature: JsonField<Boolean>) = apply {
            body.skipSignature(skipSignature)
        }
        ...
        /**
         * Returns an immutable instance of [PostCreateParams].
         *
         ...
         */
        fun build(): PostCreateParams =
            PostCreateParams(body.build(), additionalHeaders.build(), additionalQueryParams.build())
    }
    ...
    private constructor(
         ...
         *
         * Unlike [targetAccountId], this method doesn't throw if the JSON field has an unexpected
         * type.
         */
        @JsonProperty("target_account_id")
        @ExcludeMissing
        ...
        class Builder internal constructor() {
             ...
             *
             * You should usually call [Builder.targetAccountId] with a well-typed [String] value
             * instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
        ...
        private val hashCode: Int by lazy {
            Objects.hash(actionType, targetAccountId, content, delayMinutes, additionalProperties)
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is PostCreateParams &&
            body == other.body &&
    ...
    override fun toString() =
        "PostCreateParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
