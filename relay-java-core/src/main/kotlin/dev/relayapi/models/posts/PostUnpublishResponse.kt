...
private constructor(
    ...
    ) : this(id, content, createdAt, media, scheduledAt, status, targets, updatedAt, mutableMapOf())
    ...
    override fun toString() =
        "PostUnpublishResponse{id=$id, content=$content, createdAt=$createdAt, media=$media, scheduledAt=$scheduledAt, status=$status, targets=$targets, updatedAt=$updatedAt, additionalProperties=$additionalProperties}"
}
