...
private constructor(
     ...
     *
     * Unlike [threadGroupId], this method doesn't throw if the JSON field has an unexpected type.
     */
    @JsonProperty("thread_group_id")
    @ExcludeMissing
     ...
     *
     * Unlike [threadPosition], this method doesn't throw if the JSON field has an unexpected type.
     */
    @JsonProperty("thread_position")
    @ExcludeMissing
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [PostUnpublishResponse].
         *
    ...
    /** A builder for [PostUnpublishResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(postUnpublishResponse: PostUnpublishResponse) = apply {
            id = postUnpublishResponse.id
            content = postUnpublishResponse.content
            createdAt = postUnpublishResponse.createdAt
            media = postUnpublishResponse.media.map { it.toMutableList() }
            publishedAt = postUnpublishResponse.publishedAt
            recycledFromId = postUnpublishResponse.recycledFromId
            recycling = postUnpublishResponse.recycling
            scheduledAt = postUnpublishResponse.scheduledAt
            status = postUnpublishResponse.status
            targets = postUnpublishResponse.targets
            updatedAt = postUnpublishResponse.updatedAt
            metrics = postUnpublishResponse.metrics
            targetOptions = postUnpublishResponse.targetOptions
            threadGroupId = postUnpublishResponse.threadGroupId
            threadPosition = postUnpublishResponse.threadPosition
            timezone = postUnpublishResponse.timezone
            additionalProperties = postUnpublishResponse.additionalProperties.toMutableMap()
        }
         ...
         *
         * You should usually call [Builder.threadGroupId] with a well-typed [String] value instead.
         * This method is primarily for setting the field to an undocumented or not yet supported
         * value.
         */
        ...
        /**
         * Returns an immutable instance of [PostUnpublishResponse].
         *
         ...
         */
        fun build(): PostUnpublishResponse =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is PostUnpublishResponse &&
            id == other.id &&
