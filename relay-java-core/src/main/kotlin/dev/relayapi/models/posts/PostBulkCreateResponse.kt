...
private constructor(
    ...
    ) : this(data, summary, mutableMapOf())
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [PostBulkCreateResponse].
         *
    ...
    /** A builder for [PostBulkCreateResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(postBulkCreateResponse: PostBulkCreateResponse) = apply {
            data = postBulkCreateResponse.data.map { it.toMutableList() }
            summary = postBulkCreateResponse.summary
            additionalProperties = postBulkCreateResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [PostBulkCreateResponse].
         *
         ...
         */
        fun build(): PostBulkCreateResponse =
    ...
    fun validate(): PostBulkCreateResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    private constructor(
        ...
        override fun toString() =
            "Data{id=$id, content=$content, createdAt=$createdAt, media=$media, scheduledAt=$scheduledAt, status=$status, targets=$targets, updatedAt=$updatedAt, additionalProperties=$additionalProperties}"
    }
    ...
    private constructor(
        ...
        private val succeeded: JsonField<Double>,
        ...
        private constructor(
            ...
            @ExcludeMissing
            succeeded: JsonField<Double> = JsonMissing.of(),
         ...
         *   unexpectedly missing or null (e.g. if the server responded with an unexpected value).
         */
        fun succeeded(): Double = succeeded.getRequired("succeeded")
         ...
         */
        @JsonProperty("succeeded") @ExcludeMissing fun _succeeded(): JsonField<Double> = succeeded
        ...
        class Builder internal constructor() {
            ...
            private var succeeded: JsonField<Double>? = null
            ...
            fun succeeded(succeeded: Double) = succeeded(JsonField.of(succeeded))

            /**
             * Sets [Builder.succeeded] to an arbitrary JSON value.
             *
             * You should usually call [Builder.succeeded] with a well-typed [Double] value instead.
             * This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun succeeded(succeeded: JsonField<Double>) = apply { this.succeeded = succeeded }
        ...
        override fun toString() =
            "Summary{failed=$failed, succeeded=$succeeded, total=$total, additionalProperties=$additionalProperties}"
    }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is PostBulkCreateResponse &&
            data == other.data &&
            summary == other.summary &&
            additionalProperties == other.additionalProperties
    }

    private val hashCode: Int by lazy { Objects.hash(data, summary, additionalProperties) }

    override fun hashCode(): Int = hashCode

    override fun toString() =
        "PostBulkCreateResponse{data=$data, summary=$summary, additionalProperties=$additionalProperties}"
}
