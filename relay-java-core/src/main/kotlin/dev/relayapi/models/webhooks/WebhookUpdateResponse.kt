...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(webhookUpdateResponse: WebhookUpdateResponse) = apply {
            ...
            enabled = webhookUpdateResponse.enabled
            events = webhookUpdateResponse.events.map { it.toMutableList() }
    ...
    override fun toString() =
        "WebhookUpdateResponse{id=$id, createdAt=$createdAt, enabled=$enabled, events=$events, updatedAt=$updatedAt, url=$url, additionalProperties=$additionalProperties}"
}
