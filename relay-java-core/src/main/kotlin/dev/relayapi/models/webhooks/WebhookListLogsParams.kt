...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): WebhookListLogsParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [WebhookListLogsParams]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [WebhookListLogsParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(webhookListLogsParams: WebhookListLogsParams) = apply {
            cursor = webhookListLogsParams.cursor
            from = webhookListLogsParams.from
            limit = webhookListLogsParams.limit
            to = webhookListLogsParams.to
            additionalHeaders = webhookListLogsParams.additionalHeaders.toBuilder()
            additionalQueryParams = webhookListLogsParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [WebhookListLogsParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): WebhookListLogsParams =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is WebhookListLogsParams &&
            cursor == other.cursor &&
            from == other.from &&
            limit == other.limit &&
            to == other.to &&
    ...
    override fun toString() =
        "WebhookListLogsParams{cursor=$cursor, from=$from, limit=$limit, to=$to, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
