...
private constructor(
     ...
     */
    fun webhookId(): String = body.webhookId()
    ...
    class Builder internal constructor() {
        ...
        internal fun from(webhookSendTestParams: WebhookSendTestParams) = apply {
            body = webhookSendTestParams.body.toBuilder()
    ...
    private constructor(
        ...
        class Builder internal constructor() {
             ...
             */
            fun build(): Body =
                Body(checkRequired("webhookId", webhookId), additionalProperties.toMutableMap())
        }
         ...
         */
        @JvmSynthetic internal fun validity(): Int = (if (webhookId.asKnown().isPresent) 1 else 0)
        ...
        private val hashCode: Int by lazy { Objects.hash(webhookId, additionalProperties) }

        override fun hashCode(): Int = hashCode

        override fun toString() =
            "Body{webhookId=$webhookId, additionalProperties=$additionalProperties}"
    }
    ...
    override fun toString() =
        "WebhookSendTestParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
