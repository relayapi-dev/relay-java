...
class LinkedinOrganizationSwitchTypeResponse
...
private constructor(
    ...
    /** A builder for [LinkedinOrganizationSwitchTypeResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(
            linkedinOrganizationSwitchTypeResponse: LinkedinOrganizationSwitchTypeResponse
        ) = apply {
            id = linkedinOrganizationSwitchTypeResponse.id
            ...
            updatedAt = linkedinOrganizationSwitchTypeResponse.updatedAt
            username = linkedinOrganizationSwitchTypeResponse.username
            workspace = linkedinOrganizationSwitchTypeResponse.workspace
            additionalProperties =
                linkedinOrganizationSwitchTypeResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [LinkedinOrganizationSwitchTypeResponse].
         *
         ...
         */
        fun build(): LinkedinOrganizationSwitchTypeResponse =
            LinkedinOrganizationSwitchTypeResponse(
                checkRequired("id", id),
    ...
    fun validate(): LinkedinOrganizationSwitchTypeResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is LinkedinOrganizationSwitchTypeResponse &&
            id == other.id &&
    ...
    override fun toString() =
        "LinkedinOrganizationSwitchTypeResponse{id=$id, avatarUrl=$avatarUrl, connectedAt=$connectedAt, displayName=$displayName, metadata=$metadata, platform=$platform, platformAccountId=$platformAccountId, updatedAt=$updatedAt, username=$username, workspace=$workspace, additionalProperties=$additionalProperties}"
}
