...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(accountUpdateResponse: AccountUpdateResponse) = apply {
            ...
            avatarUrl = accountUpdateResponse.avatarUrl
            connectedAt = accountUpdateResponse.connectedAt
            displayName = accountUpdateResponse.displayName
            metadata = accountUpdateResponse.metadata
            platform = accountUpdateResponse.platform
            platformAccountId = accountUpdateResponse.platformAccountId
            updatedAt = accountUpdateResponse.updatedAt
            username = accountUpdateResponse.username
            workspace = accountUpdateResponse.workspace
    ...
    override fun toString() =
        "AccountUpdateResponse{id=$id, avatarUrl=$avatarUrl, connectedAt=$connectedAt, displayName=$displayName, metadata=$metadata, platform=$platform, platformAccountId=$platformAccountId, updatedAt=$updatedAt, username=$username, workspace=$workspace, additionalProperties=$additionalProperties}"
}
