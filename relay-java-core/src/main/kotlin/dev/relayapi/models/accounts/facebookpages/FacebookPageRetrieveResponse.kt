...
class FacebookPageRetrieveResponse
...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [FacebookPageRetrieveResponse].
         *
    ...
    /** A builder for [FacebookPageRetrieveResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(facebookPageRetrieveResponse: FacebookPageRetrieveResponse) = apply {
            data = facebookPageRetrieveResponse.data.map { it.toMutableList() }
            additionalProperties = facebookPageRetrieveResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [FacebookPageRetrieveResponse].
         *
         ...
         */
        fun build(): FacebookPageRetrieveResponse =
     ...
     *   type.
     */
    fun validate(): FacebookPageRetrieveResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    private constructor(
        ...
        ) : this(id, name, accessToken, mutableMapOf())
        ...
        private val hashCode: Int by lazy {
            Objects.hash(id, name, accessToken, additionalProperties)
        }

        override fun hashCode(): Int = hashCode

        override fun toString() =
            "Data{id=$id, name=$name, accessToken=$accessToken, additionalProperties=$additionalProperties}"
    }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is FacebookPageRetrieveResponse &&
            data == other.data &&
            additionalProperties == other.additionalProperties
    }
    ...
    override fun toString() =
        "FacebookPageRetrieveResponse{data=$data, additionalProperties=$additionalProperties}"
}
