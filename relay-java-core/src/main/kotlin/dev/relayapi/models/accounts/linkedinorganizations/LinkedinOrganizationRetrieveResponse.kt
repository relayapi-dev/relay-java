...
class LinkedinOrganizationRetrieveResponse
...
private constructor(
    ...
    /** A builder for [LinkedinOrganizationRetrieveResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(
            linkedinOrganizationRetrieveResponse: LinkedinOrganizationRetrieveResponse
        ) = apply {
            data = linkedinOrganizationRetrieveResponse.data.map { it.toMutableList() }
            additionalProperties =
                linkedinOrganizationRetrieveResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [LinkedinOrganizationRetrieveResponse].
         *
         ...
         */
        fun build(): LinkedinOrganizationRetrieveResponse =
            LinkedinOrganizationRetrieveResponse(
    ...
    fun validate(): LinkedinOrganizationRetrieveResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    private constructor(
        ...
        ) : this(id, name, vanityName, mutableMapOf())
        ...
        class Builder internal constructor() {
            ...
            private var vanityName: JsonField<String>? = null
            private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()
            ...
            fun build(): Data =
                Data(
                    ...
                    checkRequired("vanityName", vanityName),
                    additionalProperties.toMutableMap(),
                )
        }
        ...
        private val hashCode: Int by lazy {
            Objects.hash(id, name, vanityName, additionalProperties)
        }

        override fun hashCode(): Int = hashCode

        override fun toString() =
            "Data{id=$id, name=$name, vanityName=$vanityName, additionalProperties=$additionalProperties}"
    }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is LinkedinOrganizationRetrieveResponse &&
            data == other.data &&
            additionalProperties == other.additionalProperties
    }
    ...
    override fun toString() =
        "LinkedinOrganizationRetrieveResponse{data=$data, additionalProperties=$additionalProperties}"
}
