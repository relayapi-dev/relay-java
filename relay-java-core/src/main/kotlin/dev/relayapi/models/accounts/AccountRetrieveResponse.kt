...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(accountRetrieveResponse: AccountRetrieveResponse) = apply {
            ...
            group = accountRetrieveResponse.group
    ...
    override fun toString() =
        "AccountRetrieveResponse{id=$id, avatarUrl=$avatarUrl, connectedAt=$connectedAt, displayName=$displayName, group=$group, metadata=$metadata, platform=$platform, platformAccountId=$platformAccountId, updatedAt=$updatedAt, username=$username, additionalProperties=$additionalProperties}"
}
