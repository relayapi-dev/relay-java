...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(accountRetrieveResponse: AccountRetrieveResponse) = apply {
            ...
            avatarUrl = accountRetrieveResponse.avatarUrl
            connectedAt = accountRetrieveResponse.connectedAt
            displayName = accountRetrieveResponse.displayName
            metadata = accountRetrieveResponse.metadata
            platform = accountRetrieveResponse.platform
            platformAccountId = accountRetrieveResponse.platformAccountId
            updatedAt = accountRetrieveResponse.updatedAt
            username = accountRetrieveResponse.username
            workspace = accountRetrieveResponse.workspace
    ...
    override fun toString() =
        "AccountRetrieveResponse{id=$id, avatarUrl=$avatarUrl, connectedAt=$connectedAt, displayName=$displayName, metadata=$metadata, platform=$platform, platformAccountId=$platformAccountId, updatedAt=$updatedAt, username=$username, workspace=$workspace, additionalProperties=$additionalProperties}"
}
