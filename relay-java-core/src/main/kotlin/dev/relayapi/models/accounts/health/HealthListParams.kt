...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): HealthListParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [HealthListParams]. */
    ...
    class Builder internal constructor() {
        ...
        /**
         * Returns an immutable instance of [HealthListParams].
         *
