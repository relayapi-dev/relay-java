...
class PinterestBoardSetDefaultResponse
...
private constructor(
    ...
    /** A builder for [PinterestBoardSetDefaultResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(pinterestBoardSetDefaultResponse: PinterestBoardSetDefaultResponse) =
            apply {
                id = pinterestBoardSetDefaultResponse.id
                avatarUrl = pinterestBoardSetDefaultResponse.avatarUrl
                connectedAt = pinterestBoardSetDefaultResponse.connectedAt
                displayName = pinterestBoardSetDefaultResponse.displayName
                metadata = pinterestBoardSetDefaultResponse.metadata
                platform = pinterestBoardSetDefaultResponse.platform
                platformAccountId = pinterestBoardSetDefaultResponse.platformAccountId
                updatedAt = pinterestBoardSetDefaultResponse.updatedAt
                username = pinterestBoardSetDefaultResponse.username
                workspace = pinterestBoardSetDefaultResponse.workspace
                additionalProperties =
                    pinterestBoardSetDefaultResponse.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [PinterestBoardSetDefaultResponse].
         *
         ...
         */
        fun build(): PinterestBoardSetDefaultResponse =
            PinterestBoardSetDefaultResponse(
                checkRequired("id", id),
    ...
    fun validate(): PinterestBoardSetDefaultResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is PinterestBoardSetDefaultResponse &&
            id == other.id &&
    ...
    override fun toString() =
        "PinterestBoardSetDefaultResponse{id=$id, avatarUrl=$avatarUrl, connectedAt=$connectedAt, displayName=$displayName, metadata=$metadata, platform=$platform, platformAccountId=$platformAccountId, updatedAt=$updatedAt, username=$username, workspace=$workspace, additionalProperties=$additionalProperties}"
}
