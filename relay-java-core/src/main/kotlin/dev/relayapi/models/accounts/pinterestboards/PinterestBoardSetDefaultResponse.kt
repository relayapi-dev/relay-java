...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(pinterestBoardSetDefaultResponse: PinterestBoardSetDefaultResponse) =
            apply {
                ...
                group = pinterestBoardSetDefaultResponse.group
    ...
    override fun toString() =
        "PinterestBoardSetDefaultResponse{id=$id, avatarUrl=$avatarUrl, connectedAt=$connectedAt, displayName=$displayName, group=$group, metadata=$metadata, platform=$platform, platformAccountId=$platformAccountId, updatedAt=$updatedAt, username=$username, additionalProperties=$additionalProperties}"
}
