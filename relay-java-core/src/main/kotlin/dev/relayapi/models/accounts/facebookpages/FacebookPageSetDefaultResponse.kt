...
class FacebookPageSetDefaultResponse
...
private constructor(
    ...
    /** A builder for [FacebookPageSetDefaultResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(facebookPageSetDefaultResponse: FacebookPageSetDefaultResponse) = apply {
            id = facebookPageSetDefaultResponse.id
            avatarUrl = facebookPageSetDefaultResponse.avatarUrl
            connectedAt = facebookPageSetDefaultResponse.connectedAt
            displayName = facebookPageSetDefaultResponse.displayName
            metadata = facebookPageSetDefaultResponse.metadata
            platform = facebookPageSetDefaultResponse.platform
            platformAccountId = facebookPageSetDefaultResponse.platformAccountId
            updatedAt = facebookPageSetDefaultResponse.updatedAt
            username = facebookPageSetDefaultResponse.username
            workspace = facebookPageSetDefaultResponse.workspace
            additionalProperties =
                facebookPageSetDefaultResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [FacebookPageSetDefaultResponse].
         *
         ...
         */
        fun build(): FacebookPageSetDefaultResponse =
            FacebookPageSetDefaultResponse(
                checkRequired("id", id),
    ...
    fun validate(): FacebookPageSetDefaultResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is FacebookPageSetDefaultResponse &&
            id == other.id &&
    ...
    override fun toString() =
        "FacebookPageSetDefaultResponse{id=$id, avatarUrl=$avatarUrl, connectedAt=$connectedAt, displayName=$displayName, metadata=$metadata, platform=$platform, platformAccountId=$platformAccountId, updatedAt=$updatedAt, username=$username, workspace=$workspace, additionalProperties=$additionalProperties}"
}
