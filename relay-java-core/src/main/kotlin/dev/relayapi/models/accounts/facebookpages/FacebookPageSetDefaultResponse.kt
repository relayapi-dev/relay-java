...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(facebookPageSetDefaultResponse: FacebookPageSetDefaultResponse) = apply {
            ...
            group = facebookPageSetDefaultResponse.group
    ...
    override fun toString() =
        "FacebookPageSetDefaultResponse{id=$id, avatarUrl=$avatarUrl, connectedAt=$connectedAt, displayName=$displayName, group=$group, metadata=$metadata, platform=$platform, platformAccountId=$platformAccountId, updatedAt=$updatedAt, username=$username, additionalProperties=$additionalProperties}"
}
