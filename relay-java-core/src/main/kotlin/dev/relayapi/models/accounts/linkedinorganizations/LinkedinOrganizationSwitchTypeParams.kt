...
class LinkedinOrganizationSwitchTypeParams
private constructor(
    ...
    /** A builder for [LinkedinOrganizationSwitchTypeParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(
            linkedinOrganizationSwitchTypeParams: LinkedinOrganizationSwitchTypeParams
        ) = apply {
            id = linkedinOrganizationSwitchTypeParams.id
            body = linkedinOrganizationSwitchTypeParams.body.toBuilder()
            additionalHeaders = linkedinOrganizationSwitchTypeParams.additionalHeaders.toBuilder()
            additionalQueryParams =
                linkedinOrganizationSwitchTypeParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [LinkedinOrganizationSwitchTypeParams].
         *
         ...
         */
        fun build(): LinkedinOrganizationSwitchTypeParams =
            LinkedinOrganizationSwitchTypeParams(
                id,
                body.build(),
    ...
    private constructor(
        ...
        ) : this(accountType, organizationId, mutableMapOf())
        ...
        private val hashCode: Int by lazy {
            Objects.hash(accountType, organizationId, additionalProperties)
        }

        override fun hashCode(): Int = hashCode

        override fun toString() =
            "Body{accountType=$accountType, organizationId=$organizationId, additionalProperties=$additionalProperties}"
    }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is LinkedinOrganizationSwitchTypeParams &&
            id == other.id &&
            body == other.body &&
    ...
    override fun toString() =
        "LinkedinOrganizationSwitchTypeParams{id=$id, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
