...
class PinterestBoardSetDefaultParams
private constructor(
    ...
    /** A builder for [PinterestBoardSetDefaultParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(pinterestBoardSetDefaultParams: PinterestBoardSetDefaultParams) = apply {
            id = pinterestBoardSetDefaultParams.id
            body = pinterestBoardSetDefaultParams.body.toBuilder()
            additionalHeaders = pinterestBoardSetDefaultParams.additionalHeaders.toBuilder()
            additionalQueryParams = pinterestBoardSetDefaultParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [PinterestBoardSetDefaultParams].
         *
         ...
         */
        fun build(): PinterestBoardSetDefaultParams =
            PinterestBoardSetDefaultParams(
                id,
                body.build(),
    ...
    private constructor(
        ...
        class Builder internal constructor() {
             ...
             */
            fun build(): Body =
                Body(checkRequired("boardId", boardId), additionalProperties.toMutableMap())
        }
         ...
         */
        @JvmSynthetic internal fun validity(): Int = (if (boardId.asKnown().isPresent) 1 else 0)
        ...
        private val hashCode: Int by lazy { Objects.hash(boardId, additionalProperties) }

        override fun hashCode(): Int = hashCode

        override fun toString() =
            "Body{boardId=$boardId, additionalProperties=$additionalProperties}"
    }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is PinterestBoardSetDefaultParams &&
            id == other.id &&
            body == other.body &&
    ...
    override fun toString() =
        "PinterestBoardSetDefaultParams{id=$id, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
