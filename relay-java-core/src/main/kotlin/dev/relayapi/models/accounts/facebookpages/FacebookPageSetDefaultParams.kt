...
class FacebookPageSetDefaultParams
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [FacebookPageSetDefaultParams].
         *
    ...
    /** A builder for [FacebookPageSetDefaultParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(facebookPageSetDefaultParams: FacebookPageSetDefaultParams) = apply {
            id = facebookPageSetDefaultParams.id
            body = facebookPageSetDefaultParams.body.toBuilder()
            additionalHeaders = facebookPageSetDefaultParams.additionalHeaders.toBuilder()
            additionalQueryParams = facebookPageSetDefaultParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [FacebookPageSetDefaultParams].
         *
         ...
         */
        fun build(): FacebookPageSetDefaultParams =
    ...
    private constructor(
        ...
        class Builder internal constructor() {
             ...
             */
            fun build(): Body =
                Body(checkRequired("pageId", pageId), additionalProperties.toMutableMap())
        }
         ...
         */
        @JvmSynthetic internal fun validity(): Int = (if (pageId.asKnown().isPresent) 1 else 0)
        ...
        private val hashCode: Int by lazy { Objects.hash(pageId, additionalProperties) }

        override fun hashCode(): Int = hashCode

        override fun toString() = "Body{pageId=$pageId, additionalProperties=$additionalProperties}"
    }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is FacebookPageSetDefaultParams &&
            id == other.id &&
            body == other.body &&
    ...
    override fun toString() =
        "FacebookPageSetDefaultParams{id=$id, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
