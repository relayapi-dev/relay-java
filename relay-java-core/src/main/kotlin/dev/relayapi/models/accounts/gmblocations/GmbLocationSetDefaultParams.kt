...
class GmbLocationSetDefaultParams
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [GmbLocationSetDefaultParams].
         *
    ...
    /** A builder for [GmbLocationSetDefaultParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(gmbLocationSetDefaultParams: GmbLocationSetDefaultParams) = apply {
            id = gmbLocationSetDefaultParams.id
            body = gmbLocationSetDefaultParams.body.toBuilder()
            additionalHeaders = gmbLocationSetDefaultParams.additionalHeaders.toBuilder()
            additionalQueryParams = gmbLocationSetDefaultParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [GmbLocationSetDefaultParams].
         *
         ...
         */
        fun build(): GmbLocationSetDefaultParams =
    ...
    private constructor(
        ...
        class Builder internal constructor() {
             ...
             */
            fun build(): Body =
                Body(checkRequired("locationId", locationId), additionalProperties.toMutableMap())
        }
         ...
         */
        @JvmSynthetic internal fun validity(): Int = (if (locationId.asKnown().isPresent) 1 else 0)
        ...
        private val hashCode: Int by lazy { Objects.hash(locationId, additionalProperties) }

        override fun hashCode(): Int = hashCode

        override fun toString() =
            "Body{locationId=$locationId, additionalProperties=$additionalProperties}"
    }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is GmbLocationSetDefaultParams &&
            id == other.id &&
            body == other.body &&
    ...
    override fun toString() =
        "GmbLocationSetDefaultParams{id=$id, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
