...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(commentListResponse: CommentListResponse) = apply {
            ...
            hasMore = commentListResponse.hasMore
            nextCursor = commentListResponse.nextCursor
            platform = commentListResponse.platform
            postId = commentListResponse.postId
    ...
    override fun toString() =
        "CommentListResponse{data=$data, hasMore=$hasMore, nextCursor=$nextCursor, platform=$platform, postId=$postId, additionalProperties=$additionalProperties}"
}
