...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [MessageEditResponse].
         *
    ...
    /** A builder for [MessageEditResponse]. */
    class Builder internal constructor() {
        ...
        /**
         * Returns an immutable instance of [MessageEditResponse].
         *
    ...
    fun validate(): MessageEditResponse = apply {
        if (validated) {
            return@apply
        }
