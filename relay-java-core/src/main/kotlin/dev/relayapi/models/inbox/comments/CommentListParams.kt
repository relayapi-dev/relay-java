...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(commentListParams: CommentListParams) = apply {
            accountId = commentListParams.accountId
            cursor = commentListParams.cursor
            limit = commentListParams.limit
            platform = commentListParams.platform
    ...
    override fun toString() =
        "CommentListParams{accountId=$accountId, cursor=$cursor, limit=$limit, platform=$platform, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
