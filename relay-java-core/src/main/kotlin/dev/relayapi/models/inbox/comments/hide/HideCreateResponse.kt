...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [HideCreateResponse].
         *
    ...
    /** A builder for [HideCreateResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(hideCreateResponse: HideCreateResponse) = apply {
            success = hideCreateResponse.success
            commentId = hideCreateResponse.commentId
            additionalProperties = hideCreateResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [HideCreateResponse].
         *
    ...
    fun validate(): HideCreateResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is HideCreateResponse &&
    ...
    override fun toString() =
        "HideCreateResponse{success=$success, commentId=$commentId, additionalProperties=$additionalProperties}"
}
