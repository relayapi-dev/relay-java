...
class ReviewListParams
private constructor(
    private val accountId: String?,
    private val cursor: String?,
    private val limit: Long?,
    private val maxRating: Long?,
    private val minRating: Long?,
    ...
    fun maxRating(): Optional<Long> = Optional.ofNullable(maxRating)

    fun minRating(): Optional<Long> = Optional.ofNullable(minRating)
    ...
    companion object {
        ...
        @JvmStatic fun none(): ReviewListParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [ReviewListParams]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [ReviewListParams]. */
    class Builder internal constructor() {

        private var accountId: String? = null
        private var cursor: String? = null
        private var limit: Long? = null
        private var maxRating: Long? = null
        private var minRating: Long? = null
        private var platform: Platform? = null
        private var additionalHeaders: Headers.Builder = Headers.builder()
        private var additionalQueryParams: QueryParams.Builder = QueryParams.builder()

        @JvmSynthetic
        internal fun from(reviewListParams: ReviewListParams) = apply {
            accountId = reviewListParams.accountId
            cursor = reviewListParams.cursor
            limit = reviewListParams.limit
            maxRating = reviewListParams.maxRating
            minRating = reviewListParams.minRating
            platform = reviewListParams.platform
            additionalHeaders = reviewListParams.additionalHeaders.toBuilder()
            additionalQueryParams = reviewListParams.additionalQueryParams.toBuilder()
        }
        ...
        fun maxRating(maxRating: Long?) = apply { this.maxRating = maxRating }

        /**
         * Alias for [Builder.maxRating].
         *
         * This unboxed primitive overload exists for backwards compatibility.
         */
        fun maxRating(maxRating: Long) = maxRating(maxRating as Long?)

        /** Alias for calling [Builder.maxRating] with `maxRating.orElse(null)`. */
        fun maxRating(maxRating: Optional<Long>) = maxRating(maxRating.getOrNull())

        fun minRating(minRating: Long?) = apply { this.minRating = minRating }

        /**
         * Alias for [Builder.minRating].
         *
         * This unboxed primitive overload exists for backwards compatibility.
         */
        fun minRating(minRating: Long) = minRating(minRating as Long?)

        /** Alias for calling [Builder.minRating] with `minRating.orElse(null)`. */
        fun minRating(minRating: Optional<Long>) = minRating(minRating.getOrNull())
        ...
        /**
         * Returns an immutable instance of [ReviewListParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): ReviewListParams =
            ReviewListParams(
                accountId,
                cursor,
                limit,
    ...
    override fun _queryParams(): QueryParams =
        QueryParams.builder()
            .apply {
                ...
                maxRating?.let { put("max_rating", it.toString()) }
                minRating?.let { put("min_rating", it.toString()) }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ReviewListParams &&
    ...
    override fun toString() =
        "ReviewListParams{accountId=$accountId, cursor=$cursor, limit=$limit, maxRating=$maxRating, minRating=$minRating, platform=$platform, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
