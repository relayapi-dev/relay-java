...
class CommentPrivateReplyResponse
...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [CommentPrivateReplyResponse].
         *
    ...
    /** A builder for [CommentPrivateReplyResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(commentPrivateReplyResponse: CommentPrivateReplyResponse) = apply {
            success = commentPrivateReplyResponse.success
            commentId = commentPrivateReplyResponse.commentId
            additionalProperties = commentPrivateReplyResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [CommentPrivateReplyResponse].
         *
         ...
         */
        fun build(): CommentPrivateReplyResponse =
    ...
    fun validate(): CommentPrivateReplyResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is CommentPrivateReplyResponse &&
    ...
    override fun toString() =
        "CommentPrivateReplyResponse{success=$success, commentId=$commentId, additionalProperties=$additionalProperties}"
}
