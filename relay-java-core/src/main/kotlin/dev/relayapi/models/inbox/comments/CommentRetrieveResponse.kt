...
private constructor(
    ...
    ) : this(data, hasMore, nextCursor, platform, postId, mutableMapOf())
    ...
    class Builder internal constructor() {
        ...
        internal fun from(commentRetrieveResponse: CommentRetrieveResponse) = apply {
            data = commentRetrieveResponse.data.map { it.toMutableList() }
            hasMore = commentRetrieveResponse.hasMore
            nextCursor = commentRetrieveResponse.nextCursor
            platform = commentRetrieveResponse.platform
            postId = commentRetrieveResponse.postId
    ...
    private constructor(
         ...
         *   server responded with an unexpected value).
         */
        fun authorAvatar(): Optional<String> = authorAvatar.getOptional("author_avatar")
         ...
         *   server responded with an unexpected value).
         */
        fun repliesCount(): Optional<Double> = repliesCount.getOptional("replies_count")
        ...
        @JsonProperty("author_avatar")
        @ExcludeMissing
        fun _authorAvatar(): JsonField<String> = authorAvatar
         ...
         *
         * Unlike [repliesCount], this method doesn't throw if the JSON field has an unexpected
         * type.
         */
        @JsonProperty("replies_count")
        @ExcludeMissing
        fun _repliesCount(): JsonField<Double> = repliesCount
        ...
        class Builder internal constructor() {
            ...
            /** Alias for calling [Builder.authorAvatar] with `authorAvatar.orElse(null)`. */
            fun authorAvatar(authorAvatar: Optional<String>) =
                authorAvatar(authorAvatar.getOrNull())

            /**
             * Sets [Builder.authorAvatar] to an arbitrary JSON value.
             *
             * You should usually call [Builder.authorAvatar] with a well-typed [String] value
             * instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun authorAvatar(authorAvatar: JsonField<String>) = apply {
            ...
            /**
             * Sets [Builder.repliesCount] to an arbitrary JSON value.
             *
             * You should usually call [Builder.repliesCount] with a well-typed [Double] value
             * instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun repliesCount(repliesCount: JsonField<Double>) = apply {
    ...
    private val hashCode: Int by lazy {
        Objects.hash(data, hasMore, nextCursor, platform, postId, additionalProperties)
    }

    override fun hashCode(): Int = hashCode

    override fun toString() =
        "CommentRetrieveResponse{data=$data, hasMore=$hasMore, nextCursor=$nextCursor, platform=$platform, postId=$postId, additionalProperties=$additionalProperties}"
}
