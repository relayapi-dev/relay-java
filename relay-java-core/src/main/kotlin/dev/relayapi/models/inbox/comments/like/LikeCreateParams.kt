...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): LikeCreateParams = builder().build()
    ...
    class Builder internal constructor() {
        ...
        internal fun from(likeCreateParams: LikeCreateParams) = apply {
            commentId = likeCreateParams.commentId
            accountId = likeCreateParams.accountId
    ...
    override fun toString() =
        "LikeCreateParams{commentId=$commentId, accountId=$accountId, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams, additionalBodyProperties=$additionalBodyProperties}"
}
