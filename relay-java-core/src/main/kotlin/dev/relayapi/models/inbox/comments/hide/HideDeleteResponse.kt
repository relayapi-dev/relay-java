...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [HideDeleteResponse].
         *
    ...
    /** A builder for [HideDeleteResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(hideDeleteResponse: HideDeleteResponse) = apply {
            success = hideDeleteResponse.success
            commentId = hideDeleteResponse.commentId
            additionalProperties = hideDeleteResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [HideDeleteResponse].
         *
    ...
    fun validate(): HideDeleteResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is HideDeleteResponse &&
    ...
    override fun toString() =
        "HideDeleteResponse{success=$success, commentId=$commentId, additionalProperties=$additionalProperties}"
}
