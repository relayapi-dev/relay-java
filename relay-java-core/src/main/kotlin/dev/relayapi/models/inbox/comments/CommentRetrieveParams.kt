...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): CommentRetrieveParams = builder().build()
    ...
    class Builder internal constructor() {
        ...
        internal fun from(commentRetrieveParams: CommentRetrieveParams) = apply {
            postId = commentRetrieveParams.postId
            accountId = commentRetrieveParams.accountId
            cursor = commentRetrieveParams.cursor
            limit = commentRetrieveParams.limit
            platform = commentRetrieveParams.platform
    ...
    override fun toString() =
        "CommentRetrieveParams{postId=$postId, accountId=$accountId, cursor=$cursor, limit=$limit, platform=$platform, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
