...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): HideCreateParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [HideCreateParams]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [HideCreateParams]. */
    class Builder internal constructor() {
        ...
        /**
         * Returns an immutable instance of [HideCreateParams].
         *
