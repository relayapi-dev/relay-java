...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [CommentDeleteResponse].
         *
    ...
    /** A builder for [CommentDeleteResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(commentDeleteResponse: CommentDeleteResponse) = apply {
            success = commentDeleteResponse.success
            commentId = commentDeleteResponse.commentId
            additionalProperties = commentDeleteResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [CommentDeleteResponse].
         *
         ...
         */
        fun build(): CommentDeleteResponse =
    ...
    fun validate(): CommentDeleteResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is CommentDeleteResponse &&
    ...
    override fun toString() =
        "CommentDeleteResponse{success=$success, commentId=$commentId, additionalProperties=$additionalProperties}"
}
