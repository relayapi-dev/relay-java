...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [RetweetUndoResponse].
         *
    ...
    /** A builder for [RetweetUndoResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(retweetUndoResponse: RetweetUndoResponse) = apply {
            success = retweetUndoResponse.success
            data = retweetUndoResponse.data
            error = retweetUndoResponse.error
            additionalProperties = retweetUndoResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [RetweetUndoResponse].
         *
    ...
    fun validate(): RetweetUndoResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is RetweetUndoResponse &&
    ...
    override fun toString() =
        "RetweetUndoResponse{success=$success, data=$data, error=$error, additionalProperties=$additionalProperties}"
}
