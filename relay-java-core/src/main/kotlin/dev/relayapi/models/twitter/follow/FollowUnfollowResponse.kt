...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [FollowUnfollowResponse].
         *
    ...
    /** A builder for [FollowUnfollowResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(followUnfollowResponse: FollowUnfollowResponse) = apply {
            success = followUnfollowResponse.success
            data = followUnfollowResponse.data
            error = followUnfollowResponse.error
            additionalProperties = followUnfollowResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [FollowUnfollowResponse].
         *
         ...
         */
        fun build(): FollowUnfollowResponse =
    ...
    fun validate(): FollowUnfollowResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is FollowUnfollowResponse &&
    ...
    override fun toString() =
        "FollowUnfollowResponse{success=$success, data=$data, error=$error, additionalProperties=$additionalProperties}"
}
