...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [BookmarkCreateResponse].
         *
    ...
    /** A builder for [BookmarkCreateResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(bookmarkCreateResponse: BookmarkCreateResponse) = apply {
            success = bookmarkCreateResponse.success
            data = bookmarkCreateResponse.data
            error = bookmarkCreateResponse.error
            additionalProperties = bookmarkCreateResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [BookmarkCreateResponse].
         *
         ...
         */
        fun build(): BookmarkCreateResponse =
    ...
    fun validate(): BookmarkCreateResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BookmarkCreateResponse &&
    ...
    override fun toString() =
        "BookmarkCreateResponse{success=$success, data=$data, error=$error, additionalProperties=$additionalProperties}"
}
