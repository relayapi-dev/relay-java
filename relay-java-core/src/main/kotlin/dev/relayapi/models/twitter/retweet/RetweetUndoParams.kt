...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [RetweetUndoParams].
         *
    ...
    /** A builder for [RetweetUndoParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(retweetUndoParams: RetweetUndoParams) = apply {
            body = retweetUndoParams.body.toBuilder()
            additionalHeaders = retweetUndoParams.additionalHeaders.toBuilder()
            additionalQueryParams = retweetUndoParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [RetweetUndoParams].
         *
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is RetweetUndoParams &&
            body == other.body &&
    ...
    override fun toString() =
        "RetweetUndoParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
