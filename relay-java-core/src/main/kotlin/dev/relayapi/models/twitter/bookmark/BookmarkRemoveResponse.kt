...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [BookmarkRemoveResponse].
         *
    ...
    /** A builder for [BookmarkRemoveResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(bookmarkRemoveResponse: BookmarkRemoveResponse) = apply {
            success = bookmarkRemoveResponse.success
            data = bookmarkRemoveResponse.data
            error = bookmarkRemoveResponse.error
            additionalProperties = bookmarkRemoveResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [BookmarkRemoveResponse].
         *
         ...
         */
        fun build(): BookmarkRemoveResponse =
    ...
    fun validate(): BookmarkRemoveResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BookmarkRemoveResponse &&
    ...
    override fun toString() =
        "BookmarkRemoveResponse{success=$success, data=$data, error=$error, additionalProperties=$additionalProperties}"
}
