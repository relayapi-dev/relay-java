...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [BookmarkRemoveParams].
         *
    ...
    /** A builder for [BookmarkRemoveParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(bookmarkRemoveParams: BookmarkRemoveParams) = apply {
            body = bookmarkRemoveParams.body.toBuilder()
            additionalHeaders = bookmarkRemoveParams.additionalHeaders.toBuilder()
            additionalQueryParams = bookmarkRemoveParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [BookmarkRemoveParams].
         *
         ...
         */
        fun build(): BookmarkRemoveParams =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BookmarkRemoveParams &&
            body == other.body &&
    ...
    override fun toString() =
        "BookmarkRemoveParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
