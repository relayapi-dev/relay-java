...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [SlotCreateResponse].
         *
    ...
    /** A builder for [SlotCreateResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(slotCreateResponse: SlotCreateResponse) = apply {
            id = slotCreateResponse.id
            createdAt = slotCreateResponse.createdAt
            isDefault = slotCreateResponse.isDefault
            slots = slotCreateResponse.slots.map { it.toMutableList() }
            updatedAt = slotCreateResponse.updatedAt
            name = slotCreateResponse.name
            additionalProperties = slotCreateResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [SlotCreateResponse].
         *
    ...
    fun validate(): SlotCreateResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is SlotCreateResponse &&
            id == other.id &&
    ...
    override fun toString() =
        "SlotCreateResponse{id=$id, createdAt=$createdAt, isDefault=$isDefault, slots=$slots, updatedAt=$updatedAt, name=$name, additionalProperties=$additionalProperties}"
}
