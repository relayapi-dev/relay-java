...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [SlotUpdateResponse].
         *
    ...
    /** A builder for [SlotUpdateResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(slotUpdateResponse: SlotUpdateResponse) = apply {
            id = slotUpdateResponse.id
            createdAt = slotUpdateResponse.createdAt
            isDefault = slotUpdateResponse.isDefault
            slots = slotUpdateResponse.slots.map { it.toMutableList() }
            updatedAt = slotUpdateResponse.updatedAt
            name = slotUpdateResponse.name
            additionalProperties = slotUpdateResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [SlotUpdateResponse].
         *
    ...
    fun validate(): SlotUpdateResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is SlotUpdateResponse &&
            id == other.id &&
    ...
    override fun toString() =
        "SlotUpdateResponse{id=$id, createdAt=$createdAt, isDefault=$isDefault, slots=$slots, updatedAt=$updatedAt, name=$name, additionalProperties=$additionalProperties}"
}
