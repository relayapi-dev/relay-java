    ...
    private constructor(
        ...
        class Builder internal constructor() {
            ...
            internal fun from(data: Data) = apply {
                ...
                prefix = data.prefix
                start = data.start
                workspaceScope = data.workspaceScope
        ...
        private constructor(
             ...
             * ```
             *
             * @throws RelayInvalidDataException if [Visitor.unknown] is not overridden in [visitor]
            ...
            companion object {
                ...
                fun ofStrings(strings: List<String>) =
                    WorkspaceScope(strings = strings.toImmutable())
            }

            /**
             * An interface that defines how to map each variant of [WorkspaceScope] to a value of
             * type [T].
             */
            interface Visitor<out T> {
                 ...
                 *
                 * An instance of [WorkspaceScope] can contain an unknown variant if it was
        ...
        override fun toString() =
            "Data{id=$id, createdAt=$createdAt, enabled=$enabled, expiresAt=$expiresAt, name=$name, permission=$permission, prefix=$prefix, start=$start, workspaceScope=$workspaceScope, additionalProperties=$additionalProperties}"
    }
