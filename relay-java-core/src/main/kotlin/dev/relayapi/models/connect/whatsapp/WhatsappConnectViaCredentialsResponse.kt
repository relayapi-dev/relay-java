...
class WhatsappConnectViaCredentialsResponse
...
private constructor(
    ...
    /** A builder for [WhatsappConnectViaCredentialsResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(
            whatsappConnectViaCredentialsResponse: WhatsappConnectViaCredentialsResponse
        ) = apply {
            account = whatsappConnectViaCredentialsResponse.account
            additionalProperties =
                whatsappConnectViaCredentialsResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [WhatsappConnectViaCredentialsResponse].
         *
         ...
         */
        fun build(): WhatsappConnectViaCredentialsResponse =
            WhatsappConnectViaCredentialsResponse(
    ...
    fun validate(): WhatsappConnectViaCredentialsResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is WhatsappConnectViaCredentialsResponse &&
    ...
    override fun toString() =
        "WhatsappConnectViaCredentialsResponse{account=$account, additionalProperties=$additionalProperties}"
}
