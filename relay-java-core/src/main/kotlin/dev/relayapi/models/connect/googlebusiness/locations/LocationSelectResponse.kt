...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [LocationSelectResponse].
         *
    ...
    /** A builder for [LocationSelectResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(locationSelectResponse: LocationSelectResponse) = apply {
            account = locationSelectResponse.account
            additionalProperties = locationSelectResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [LocationSelectResponse].
         *
         ...
         */
        fun build(): LocationSelectResponse =
    ...
    fun validate(): LocationSelectResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is LocationSelectResponse &&
    ...
    override fun toString() =
        "LocationSelectResponse{account=$account, additionalProperties=$additionalProperties}"
}
