...
class TelegramConnectDirectlyResponse
...
private constructor(
    ...
    /** A builder for [TelegramConnectDirectlyResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(telegramConnectDirectlyResponse: TelegramConnectDirectlyResponse) =
            apply {
                account = telegramConnectDirectlyResponse.account
                additionalProperties =
                    telegramConnectDirectlyResponse.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [TelegramConnectDirectlyResponse].
         *
         ...
         */
        fun build(): TelegramConnectDirectlyResponse =
            TelegramConnectDirectlyResponse(
    ...
    fun validate(): TelegramConnectDirectlyResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is TelegramConnectDirectlyResponse &&
    ...
    override fun toString() =
        "TelegramConnectDirectlyResponse{account=$account, additionalProperties=$additionalProperties}"
}
