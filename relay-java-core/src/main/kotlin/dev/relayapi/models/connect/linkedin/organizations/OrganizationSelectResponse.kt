...
class OrganizationSelectResponse
...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [OrganizationSelectResponse].
         *
    ...
    /** A builder for [OrganizationSelectResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(organizationSelectResponse: OrganizationSelectResponse) = apply {
            account = organizationSelectResponse.account
            additionalProperties = organizationSelectResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [OrganizationSelectResponse].
         *
         ...
         */
        fun build(): OrganizationSelectResponse =
    ...
    fun validate(): OrganizationSelectResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is OrganizationSelectResponse &&
    ...
    override fun toString() =
        "OrganizationSelectResponse{account=$account, additionalProperties=$additionalProperties}"
}
