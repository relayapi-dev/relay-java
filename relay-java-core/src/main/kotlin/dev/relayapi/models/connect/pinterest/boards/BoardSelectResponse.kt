...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [BoardSelectResponse].
         *
    ...
    /** A builder for [BoardSelectResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(boardSelectResponse: BoardSelectResponse) = apply {
            account = boardSelectResponse.account
            additionalProperties = boardSelectResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [BoardSelectResponse].
         *
    ...
    fun validate(): BoardSelectResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BoardSelectResponse &&
    ...
    override fun toString() =
        "BoardSelectResponse{account=$account, additionalProperties=$additionalProperties}"
}
