...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [PageSelectResponse].
         *
    ...
    /** A builder for [PageSelectResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(pageSelectResponse: PageSelectResponse) = apply {
            account = pageSelectResponse.account
            additionalProperties = pageSelectResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [PageSelectResponse].
         *
    ...
    fun validate(): PageSelectResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is PageSelectResponse &&
    ...
    override fun toString() =
        "PageSelectResponse{account=$account, additionalProperties=$additionalProperties}"
}
