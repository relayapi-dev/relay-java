...
class TelegramPollConnectionStatusResponse
@JsonCreator(mode = JsonCreator.Mode.DISABLED)
private constructor(
    private val status: JsonField<Status>,
    private val account: JsonField<Account>,
    private val chatId: JsonField<String>,
    private val chatTitle: JsonField<String>,
    private val chatType: JsonField<String>,
    ...
    private constructor(
        ...
        @JsonProperty("chat_title") @ExcludeMissing chatTitle: JsonField<String> = JsonMissing.of(),
        @JsonProperty("chat_type") @ExcludeMissing chatType: JsonField<String> = JsonMissing.of(),
        @JsonProperty("expires_at")
        @ExcludeMissing
        expiresAt: JsonField<OffsetDateTime> = JsonMissing.of(),
    ) : this(status, account, chatId, chatTitle, chatType, expiresAt, mutableMapOf())
     ...
     *   server responded with an unexpected value).
     */
    fun chatTitle(): Optional<String> = chatTitle.getOptional("chat_title")
     ...
     *   server responded with an unexpected value).
     */
    fun chatType(): Optional<String> = chatType.getOptional("chat_type")
    ...
    /**
     * Returns the raw JSON value of [chatTitle].
     *
     * Unlike [chatTitle], this method doesn't throw if the JSON field has an unexpected type.
     */
    @JsonProperty("chat_title") @ExcludeMissing fun _chatTitle(): JsonField<String> = chatTitle

    /**
     * Returns the raw JSON value of [chatType].
     *
     * Unlike [chatType], this method doesn't throw if the JSON field has an unexpected type.
     */
    @JsonProperty("chat_type") @ExcludeMissing fun _chatType(): JsonField<String> = chatType
    ...
    /** A builder for [TelegramPollConnectionStatusResponse]. */
    class Builder internal constructor() {

        private var status: JsonField<Status>? = null
        private var account: JsonField<Account> = JsonMissing.of()
        private var chatId: JsonField<String> = JsonMissing.of()
        private var chatTitle: JsonField<String> = JsonMissing.of()
        private var chatType: JsonField<String> = JsonMissing.of()
        private var expiresAt: JsonField<OffsetDateTime> = JsonMissing.of()
        private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

        @JvmSynthetic
        internal fun from(
            telegramPollConnectionStatusResponse: TelegramPollConnectionStatusResponse
        ) = apply {
            status = telegramPollConnectionStatusResponse.status
            account = telegramPollConnectionStatusResponse.account
            chatId = telegramPollConnectionStatusResponse.chatId
            chatTitle = telegramPollConnectionStatusResponse.chatTitle
            chatType = telegramPollConnectionStatusResponse.chatType
            expiresAt = telegramPollConnectionStatusResponse.expiresAt
            additionalProperties =
                telegramPollConnectionStatusResponse.additionalProperties.toMutableMap()
        }
        ...
        /** Chat or channel title */
        fun chatTitle(chatTitle: String) = chatTitle(JsonField.of(chatTitle))

        /**
         * Sets [Builder.chatTitle] to an arbitrary JSON value.
         *
         * You should usually call [Builder.chatTitle] with a well-typed [String] value instead.
         * This method is primarily for setting the field to an undocumented or not yet supported
         * value.
         */
        fun chatTitle(chatTitle: JsonField<String>) = apply { this.chatTitle = chatTitle }

        /** Chat type (private, group, supergroup, channel) */
        fun chatType(chatType: String) = chatType(JsonField.of(chatType))

        /**
         * Sets [Builder.chatType] to an arbitrary JSON value.
         *
         * You should usually call [Builder.chatType] with a well-typed [String] value instead. This
         * method is primarily for setting the field to an undocumented or not yet supported value.
         */
        fun chatType(chatType: JsonField<String>) = apply { this.chatType = chatType }
        ...
        /**
         * Returns an immutable instance of [TelegramPollConnectionStatusResponse].
         *
         ...
         */
        fun build(): TelegramPollConnectionStatusResponse =
            TelegramPollConnectionStatusResponse(
    ...
    fun validate(): TelegramPollConnectionStatusResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    internal fun validity(): Int =
        (status.asKnown().getOrNull()?.validity() ?: 0) +
            ...
            (if (chatTitle.asKnown().isPresent) 1 else 0) +
            (if (chatType.asKnown().isPresent) 1 else 0) +
    ...
    private constructor(
        ...
        override fun toString() =
            "Account{id=$id, avatarUrl=$avatarUrl, connectedAt=$connectedAt, displayName=$displayName, metadata=$metadata, platform=$platform, platformAccountId=$platformAccountId, updatedAt=$updatedAt, username=$username, workspace=$workspace, additionalProperties=$additionalProperties}"
    }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is TelegramPollConnectionStatusResponse &&
            status == other.status &&
    ...
    private val hashCode: Int by lazy {
        Objects.hash(status, account, chatId, chatTitle, chatType, expiresAt, additionalProperties)
    }

    override fun hashCode(): Int = hashCode

    override fun toString() =
        "TelegramPollConnectionStatusResponse{status=$status, account=$account, chatId=$chatId, chatTitle=$chatTitle, chatType=$chatType, expiresAt=$expiresAt, additionalProperties=$additionalProperties}"
}
