...
private constructor(
    ...
    /**
     * Outcome of the headless OAuth exchange. 'pending_selection' means a secondary selection step
     * (e.g. Facebook page) is required.
     *
     * @throws RelayInvalidDataException if the JSON field has an unexpected type or is unexpectedly
     *   missing or null (e.g. if the server responded with an unexpected value).
     */
    ...
    class Builder internal constructor() {
        ...
        internal fun from(connectFetchPendingDataResponse: ConnectFetchPendingDataResponse) =
            apply {
                ...
                status = connectFetchPendingDataResponse.status
                account = connectFetchPendingDataResponse.account
                error = connectFetchPendingDataResponse.error
                errorCode = connectFetchPendingDataResponse.errorCode
                errorDescription = connectFetchPendingDataResponse.errorDescription
                errorMessage = connectFetchPendingDataResponse.errorMessage
        ...
        /**
         * Outcome of the headless OAuth exchange. 'pending_selection' means a secondary selection
         * step (e.g. Facebook page) is required.
         */
        ...
        fun errorDescription(errorDescription: String?) =
            errorDescription(JsonField.ofNullable(errorDescription))

        /** Alias for calling [Builder.errorDescription] with `errorDescription.orElse(null)`. */
        fun errorDescription(errorDescription: Optional<String>) =
            errorDescription(errorDescription.getOrNull())
    ...
    class Status @JsonCreator private constructor(private val value: JsonField<String>) : Enum {
        ...
        companion object {
            ...
            @JvmField val PENDING_SELECTION = of("pending_selection")
        ...
        fun value(): Value =
            when (this) {
                ...
                PENDING_SELECTION -> Value.PENDING_SELECTION
                ERROR -> Value.ERROR
                else -> Value._UNKNOWN
            }
        ...
        fun known(): Known =
            when (this) {
                ...
                PENDING_SELECTION -> Known.PENDING_SELECTION
                ERROR -> Known.ERROR
    ...
    override fun toString() =
        "ConnectFetchPendingDataResponse{platform=$platform, status=$status, account=$account, error=$error, errorCode=$errorCode, errorDescription=$errorDescription, errorMessage=$errorMessage, additionalProperties=$additionalProperties}"
}
