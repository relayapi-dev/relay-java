...
class ConnectCreateBlueskyConnectionResponse
...
private constructor(
    ...
    /** A builder for [ConnectCreateBlueskyConnectionResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(
            connectCreateBlueskyConnectionResponse: ConnectCreateBlueskyConnectionResponse
        ) = apply {
            account = connectCreateBlueskyConnectionResponse.account
            additionalProperties =
                connectCreateBlueskyConnectionResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [ConnectCreateBlueskyConnectionResponse].
         *
         ...
         */
        fun build(): ConnectCreateBlueskyConnectionResponse =
            ConnectCreateBlueskyConnectionResponse(
    ...
    fun validate(): ConnectCreateBlueskyConnectionResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ConnectCreateBlueskyConnectionResponse &&
    ...
    override fun toString() =
        "ConnectCreateBlueskyConnectionResponse{account=$account, additionalProperties=$additionalProperties}"
}
