...
class TelegramConnectDirectlyParams
private constructor(
     ...
     */
    fun _chatId(): JsonField<String> = body._chatId()
    ...
    /** A builder for [TelegramConnectDirectlyParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(telegramConnectDirectlyParams: TelegramConnectDirectlyParams) = apply {
            body = telegramConnectDirectlyParams.body.toBuilder()
            additionalHeaders = telegramConnectDirectlyParams.additionalHeaders.toBuilder()
            additionalQueryParams = telegramConnectDirectlyParams.additionalQueryParams.toBuilder()
        }
        ...
        /** Telegram chat or channel ID */
        fun chatId(chatId: String) = apply { body.chatId(chatId) }
         ...
         */
        fun chatId(chatId: JsonField<String>) = apply { body.chatId(chatId) }
        ...
        /**
         * Returns an immutable instance of [TelegramConnectDirectlyParams].
         *
         ...
         */
        fun build(): TelegramConnectDirectlyParams =
            TelegramConnectDirectlyParams(
                body.build(),
    ...
    private constructor(
        ...
        class Builder internal constructor() {
             ...
             */
            fun build(): Body =
                Body(checkRequired("chatId", chatId), additionalProperties.toMutableMap())
        }
        ...
        override fun toString() = "Body{chatId=$chatId, additionalProperties=$additionalProperties}"
    }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is TelegramConnectDirectlyParams &&
            body == other.body &&
    ...
    override fun toString() =
        "TelegramConnectDirectlyParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
