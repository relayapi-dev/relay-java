...
class ConnectCompleteOAuthCallbackResponse
...
private constructor(
    ...
    /** A builder for [ConnectCompleteOAuthCallbackResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(
            connectCompleteOAuthCallbackResponse: ConnectCompleteOAuthCallbackResponse
        ) = apply {
            account = connectCompleteOAuthCallbackResponse.account
            additionalProperties =
                connectCompleteOAuthCallbackResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [ConnectCompleteOAuthCallbackResponse].
         *
         ...
         */
        fun build(): ConnectCompleteOAuthCallbackResponse =
            ConnectCompleteOAuthCallbackResponse(
    ...
    fun validate(): ConnectCompleteOAuthCallbackResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ConnectCompleteOAuthCallbackResponse &&
    ...
    override fun toString() =
        "ConnectCompleteOAuthCallbackResponse{account=$account, additionalProperties=$additionalProperties}"
}
