...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [ProfileSelectResponse].
         *
    ...
    /** A builder for [ProfileSelectResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(profileSelectResponse: ProfileSelectResponse) = apply {
            account = profileSelectResponse.account
            additionalProperties = profileSelectResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [ProfileSelectResponse].
         *
         ...
         */
        fun build(): ProfileSelectResponse =
    ...
    fun validate(): ProfileSelectResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ProfileSelectResponse &&
    ...
    override fun toString() =
        "ProfileSelectResponse{account=$account, additionalProperties=$additionalProperties}"
}
