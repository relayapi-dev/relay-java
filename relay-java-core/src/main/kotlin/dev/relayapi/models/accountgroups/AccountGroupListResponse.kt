...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [AccountGroupListResponse].
         *
    ...
    /** A builder for [AccountGroupListResponse]. */
    class Builder internal constructor() {
        ...
        /**
         * Returns an immutable instance of [AccountGroupListResponse].
         *
    ...
    fun validate(): AccountGroupListResponse = apply {
        if (validated) {
            return@apply
        }
