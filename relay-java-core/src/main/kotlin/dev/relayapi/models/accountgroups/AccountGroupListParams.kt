...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): AccountGroupListParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [AccountGroupListParams]. */
    ...
    class Builder internal constructor() {
        ...
        /**
         * Returns an immutable instance of [AccountGroupListParams].
         *
