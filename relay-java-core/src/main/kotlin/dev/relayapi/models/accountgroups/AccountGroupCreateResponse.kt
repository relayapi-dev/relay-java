...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [AccountGroupCreateResponse].
         *
    ...
    /** A builder for [AccountGroupCreateResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(accountGroupCreateResponse: AccountGroupCreateResponse) = apply {
            id = accountGroupCreateResponse.id
            accountIds = accountGroupCreateResponse.accountIds.map { it.toMutableList() }
            createdAt = accountGroupCreateResponse.createdAt
            name = accountGroupCreateResponse.name
            updatedAt = accountGroupCreateResponse.updatedAt
            additionalProperties = accountGroupCreateResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [AccountGroupCreateResponse].
         *
         ...
         */
        fun build(): AccountGroupCreateResponse =
    ...
    fun validate(): AccountGroupCreateResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is AccountGroupCreateResponse &&
            id == other.id &&
    ...
    override fun toString() =
        "AccountGroupCreateResponse{id=$id, accountIds=$accountIds, createdAt=$createdAt, name=$name, updatedAt=$updatedAt, additionalProperties=$additionalProperties}"
}
