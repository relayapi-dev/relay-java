...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        fun build(): UsageRetrieveParams =
            UsageRetrieveParams(additionalHeaders.build(), additionalQueryParams.build())
    }
    ...
    override fun toString() =
        "UsageRetrieveParams{additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
