...
class AnalyticsListDailyMetricsParams
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): AnalyticsListDailyMetricsParams = builder().build()
    ...
    /** A builder for [AnalyticsListDailyMetricsParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(analyticsListDailyMetricsParams: AnalyticsListDailyMetricsParams) =
            apply {
                accountId = analyticsListDailyMetricsParams.accountId
                fromDate = analyticsListDailyMetricsParams.fromDate
                platform = analyticsListDailyMetricsParams.platform
                toDate = analyticsListDailyMetricsParams.toDate
                additionalHeaders = analyticsListDailyMetricsParams.additionalHeaders.toBuilder()
                additionalQueryParams =
                    analyticsListDailyMetricsParams.additionalQueryParams.toBuilder()
            }
        ...
        /**
         * Returns an immutable instance of [AnalyticsListDailyMetricsParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): AnalyticsListDailyMetricsParams =
            AnalyticsListDailyMetricsParams(
                accountId,
                fromDate,
                platform,
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is AnalyticsListDailyMetricsParams &&
    ...
    override fun toString() =
        "AnalyticsListDailyMetricsParams{accountId=$accountId, fromDate=$fromDate, platform=$platform, toDate=$toDate, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
