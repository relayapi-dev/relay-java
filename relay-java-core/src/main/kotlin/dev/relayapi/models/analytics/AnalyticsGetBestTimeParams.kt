...
class AnalyticsGetBestTimeParams
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): AnalyticsGetBestTimeParams = builder().build()

        /**
         * Returns a mutable builder for constructing an instance of [AnalyticsGetBestTimeParams].
         */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [AnalyticsGetBestTimeParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(analyticsGetBestTimeParams: AnalyticsGetBestTimeParams) = apply {
            accountId = analyticsGetBestTimeParams.accountId
            fromDate = analyticsGetBestTimeParams.fromDate
            platform = analyticsGetBestTimeParams.platform
            toDate = analyticsGetBestTimeParams.toDate
            additionalHeaders = analyticsGetBestTimeParams.additionalHeaders.toBuilder()
            additionalQueryParams = analyticsGetBestTimeParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [AnalyticsGetBestTimeParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): AnalyticsGetBestTimeParams =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is AnalyticsGetBestTimeParams &&
    ...
    override fun toString() =
        "AnalyticsGetBestTimeParams{accountId=$accountId, fromDate=$fromDate, platform=$platform, toDate=$toDate, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
