...
class AnalyticsGetPostingFrequencyParams
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): AnalyticsGetPostingFrequencyParams = builder().build()
    ...
    /** A builder for [AnalyticsGetPostingFrequencyParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(analyticsGetPostingFrequencyParams: AnalyticsGetPostingFrequencyParams) =
            apply {
                accountId = analyticsGetPostingFrequencyParams.accountId
                fromDate = analyticsGetPostingFrequencyParams.fromDate
                platform = analyticsGetPostingFrequencyParams.platform
                toDate = analyticsGetPostingFrequencyParams.toDate
                additionalHeaders = analyticsGetPostingFrequencyParams.additionalHeaders.toBuilder()
                additionalQueryParams =
                    analyticsGetPostingFrequencyParams.additionalQueryParams.toBuilder()
            }
        ...
        /**
         * Returns an immutable instance of [AnalyticsGetPostingFrequencyParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): AnalyticsGetPostingFrequencyParams =
            AnalyticsGetPostingFrequencyParams(
                accountId,
                fromDate,
                platform,
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is AnalyticsGetPostingFrequencyParams &&
    ...
    override fun toString() =
        "AnalyticsGetPostingFrequencyParams{accountId=$accountId, fromDate=$fromDate, platform=$platform, toDate=$toDate, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
