...
/**
 * Upload a raw file body. Pass the filename as a query parameter and set the Content-Type header to
 * the file's actual MIME type (e.g. image/png, video/mp4). The Content-Type is validated against an
