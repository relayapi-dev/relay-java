...
import dev.relayapi.client.okhttp.OkHttpClient
import dev.relayapi.core.RequestOptions
import dev.relayapi.core.Sleeper
import dev.relayapi.errors.RelayRetryableException
        ...
        val failingHttpClient =
            object : HttpClient {
                override fun execute(
                    ...
                    callCount++
                    if (callCount == 1) {
                        throw RelayRetryableException("Simulated retryable failure")
                    }
                ...
                override fun executeAsync(
                    ...
                    if (callCount == 1) {
                        ...
                        future.completeExceptionally(
                            RelayRetryableException("Simulated retryable failure")
                        )
                        return future
                    }
